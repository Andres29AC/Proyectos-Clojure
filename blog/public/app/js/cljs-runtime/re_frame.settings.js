...
re_frame.settings.reg_global_interceptor = (function re_frame$settings$reg_global_interceptor(p__6305){
var map__6306 = p__6305;
var map__6306__$1 = cljs.core.__destructure_map(map__6306);
var interceptor = map__6306__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6306__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(re_frame.settings.store,cljs.core.update,new cljs.core.Keyword(null,"global-interceptors","global-interceptors",-1995759472),(function (global_interceptors){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_frame.interop.empty_queue,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__6314_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__6314_SHARP_));
}),global_interceptors));
}));
}));
