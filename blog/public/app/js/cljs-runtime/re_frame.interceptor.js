...
var len__5726__auto___6952 = arguments.length;
var i__5727__auto___6953 = (0);
while(true){
if((i__5727__auto___6953 < len__5726__auto___6952)){
args__5732__auto__.push((arguments[i__5727__auto___6953]));

var G__6954 = (i__5727__auto___6953 + (1));
i__5727__auto___6953 = G__6954;
continue;
} else {
}
break;
...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__6895){
var map__6896 = p__6895;
var map__6896__$1 = cljs.core.__destructure_map(map__6896);
var m = map__6896__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6896__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6896__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6896__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6896__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5802__auto___6955 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5802__auto___6955){
var unknown_keys_6956 = temp__5802__auto___6955;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_6956], 0));
} else {
}
} else {
}

var G__6909 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5002__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6909,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__6909;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq6883){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq6883));
}));
...
var args__5732__auto__ = [];
var len__5726__auto___6961 = arguments.length;
var i__5727__auto___6962 = (0);
while(true){
if((i__5727__auto___6962 < len__5726__auto___6961)){
args__5732__auto__.push((arguments[i__5727__auto___6962]));

var G__6963 = (i__5727__auto___6962 + (1));
i__5727__auto___6962 = G__6963;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq6919){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6920,G__6921,G__6922,seq6919__$3);
}));
...
var args__5732__auto__ = [];
var len__5726__auto___6970 = arguments.length;
var i__5727__auto___6971 = (0);
while(true){
if((i__5727__auto___6971 < len__5726__auto___6970)){
args__5732__auto__.push((arguments[i__5727__auto___6971]));

var G__6972 = (i__5727__auto___6971 + (1));
i__5727__auto___6971 = G__6972;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq6927){
...
var G__6930 = cljs.core.first(seq6927__$2);
var seq6927__$3 = cljs.core.next(seq6927__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6928,G__6929,G__6930,seq6927__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__6932,interceptor,direction){
var map__6934 = p__6932;
var map__6934__$1 = cljs.core.__destructure_map(map__6934);
var context = map__6934__$1;
var original_exception_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6934__$1,new cljs.core.Keyword("re-frame.interceptor","original-exception?","re-frame.interceptor/original-exception?",-527923945));
...
var args__5732__auto__ = [];
var len__5726__auto___6985 = arguments.length;
var i__5727__auto___6986 = (0);
while(true){
if((i__5727__auto___6986 < len__5726__auto___6985)){
args__5732__auto__.push((arguments[i__5727__auto___6986]));

var G__6987 = (i__5727__auto___6986 + (1));
i__5727__auto___6986 = G__6987;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.merge_ex_data.cljs$lang$applyTo = (function (seq6940){
var G__6941 = cljs.core.first(seq6940);
var seq6940__$1 = cljs.core.next(seq6940);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6941,seq6940__$1);
}));
...
var map__6944 = cljs.core.ex_data(re_frame_error);
var map__6944__$1 = cljs.core.__destructure_map(map__6944);
var event_v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6944__$1,new cljs.core.Keyword(null,"event-v","event-v",1378681365));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6944__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var interceptor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6944__$1,new cljs.core.Keyword(null,"interceptor","interceptor",1127739076));
...
return (fexpr__6945.cljs$core$IFn$_invoke$arity$1 ? fexpr__6945.cljs$core$IFn$_invoke$arity$1(interceptor) : fexpr__6945.call(null, interceptor));
})();
...
}catch (e6946){var e = e6946;
var G__6947 = cljs.core.ex_cause(e);
var G__6948 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__6947,G__6948) : error_handler.call(null, G__6947,G__6948));
}}
});
