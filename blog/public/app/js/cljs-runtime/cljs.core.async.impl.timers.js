...
var i_14569 = (self__.level + (1));
while(true){
if((i_14569 <= (new_level + (1)))){
(update[i_14569] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14574 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14574[i]));
} else {
x__$2.forward.push((((i < links_14574.length))?(links_14574[i]):null));
}

if((i < links_14574.length)){
(links_14574[i] = x__$2);
} else {
links_14574.push(x__$2);
}
...
var i_14629 = (0);
while(true){
if((i_14629 <= self__.level)){
var links_14630 = (update[i_14629]).forward;
if((x__$1 === (((i_14629 < links_14630.length))?(links_14630[i_14629]):null))){
(links_14630[i_14629] = (x__$1.forward[i_14629]));

var G__14631 = (i_14629 + (1));
i_14629 = G__14631;
continue;
} else {
var G__14632 = (i_14629 + (1));
i_14629 = G__14632;
continue;
}
} else {
...
var G__14634 = nx;
var G__14635 = (level__$1 - (1));
x = G__14634;
level__$1 = G__14635;
continue;
} else {
var G__14636 = x;
var G__14637 = (level__$1 - (1));
x = G__14636;
level__$1 = G__14637;
continue;
}
