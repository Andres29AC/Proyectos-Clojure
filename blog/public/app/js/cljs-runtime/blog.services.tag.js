...
(blog.services.tag.Tag.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k11944,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k11944,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__11949){
var vec__11950 = p__11949;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11950,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11950,(1),null);
...
(blog.services.tag.Tag.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this11945,other11946){
var self__ = this;
var this11945__$1 = this;
return (((!((other11946 == null)))) && ((((this11945__$1.constructor === other11946.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11945__$1.url,other11946.url)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11945__$1.name,other11946.name)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11945__$1.post_count,other11946.post_count)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this11945__$1.__extmap,other11946.__extmap)))))))))));
}));
...
(blog.services.tag.Tag.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k11944){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k11944);

}
}));

(blog.services.tag.Tag.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__11943){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__11954 = cljs.core.keyword_identical_QMARK_;
var expr__11955 = k__5309__auto__;
if(cljs.core.truth_((pred__11954.cljs$core$IFn$_invoke$arity$2 ? pred__11954.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"url","url",276297046),expr__11955) : pred__11954.call(null, new cljs.core.Keyword(null,"url","url",276297046),expr__11955)))){
return (new blog.services.tag.Tag(G__11943,self__.name,self__.post_count,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__11954.cljs$core$IFn$_invoke$arity$2 ? pred__11954.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"name","name",1843675177),expr__11955) : pred__11954.call(null, new cljs.core.Keyword(null,"name","name",1843675177),expr__11955)))){
return (new blog.services.tag.Tag(self__.url,G__11943,self__.post_count,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__11954.cljs$core$IFn$_invoke$arity$2 ? pred__11954.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"post-count","post-count",-1326461588),expr__11955) : pred__11954.call(null, new cljs.core.Keyword(null,"post-count","post-count",-1326461588),expr__11955)))){
return (new blog.services.tag.Tag(self__.url,self__.name,G__11943,self__.__meta,self__.__extmap,null));
} else {
return (new blog.services.tag.Tag(self__.url,self__.name,self__.post_count,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__11943),null));
}
}
}
}));
...
(blog.services.tag.Tag.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__11943){
var self__ = this;
var this__5299__auto____$1 = this;
return (new blog.services.tag.Tag(self__.url,self__.name,self__.post_count,G__11943,self__.__extmap,self__.__hash));
}));
 ...
 */
blog.services.tag.map__GT_Tag = (function blog$services$tag$map__GT_Tag(G__11947){
var extmap__5342__auto__ = (function (){var G__11957 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__11947,new cljs.core.Keyword(null,"url","url",276297046),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"post-count","post-count",-1326461588)], 0));
if(cljs.core.record_QMARK_(G__11947)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__11957);
} else {
return G__11957;
}
})();
return (new blog.services.tag.Tag(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(G__11947),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(G__11947),new cljs.core.Keyword(null,"post-count","post-count",-1326461588).cljs$core$IFn$_invoke$arity$1(G__11947),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
...
blog.services.tag.tags = new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [blog.services.tag.create_tag("/tags/clojure","Clojure",(10)),blog.services.tag.create_tag("/tags/react","React",(8)),blog.services.tag.create_tag("/tags/javascript","JavaScript",(15)),blog.services.tag.create_tag("/tags/web-development","Web Development",(20)),blog.services.tag.create_tag("/tags/programming","Programming",(25)),blog.services.tag.create_tag("/tags/functional-programming","Functional Programming",(5))], null);
