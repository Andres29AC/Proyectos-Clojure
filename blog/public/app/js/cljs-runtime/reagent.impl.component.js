...
while (G__11904__i < G__11904__a.length) {G__11904__a[G__11904__i] = arguments[G__11904__i + 0]; ++G__11904__i;}
  args = new cljs.core.IndexedSeq(G__11904__a,0,null);
} 
...
var renders_11912 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11913 = cljs.core.first(cljs.core.vals(renders_11912));
...
if((cljs.core.count(renders_11912) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11912))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11913)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11913], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
return (function() { 
var G__11915__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__11915 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__11916__i = 0, G__11916__a = new Array(arguments.length -  0);
while (G__11916__i < G__11916__a.length) {G__11916__a[G__11916__i] = arguments[G__11916__i + 0]; ++G__11916__i;}
  args = new cljs.core.IndexedSeq(G__11916__a,0,null);
} 
return G__11915__delegate.call(this,args);};
G__11915.cljs$lang$maxFixedArity = 0;
G__11915.cljs$lang$applyTo = (function (arglist__11917){
